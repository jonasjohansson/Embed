...
function setValue() {
	...
	var the_panorama = $(".surface.panorama");
	...
	var body_width = (round_width * 2) + (round_depth * 2) + 10;
	...
	$(".panorama").width(round_depth*2 + round_width);
	$(".panorama").height(round_height); 
	...
	$(".surface").each(function(){
		...
		//$(this).html('<div class="parameters"><span></span></div>');
		//$(this).find(".parameters span").html(this_width + " x " + this_height);
	}); 
