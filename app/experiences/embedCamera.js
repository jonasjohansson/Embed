...
const setupEmbedCamera = (scene = null, renderer = null) => {
	...
	var camera = new THREE.CubeCamera(0.1, 200000, 128);
	scene.add(camera);
	...
	for (let cam of camera.children) {
		switch (cam.index) {
			...
			case 1:
				...
				if (panorama) v = [SCREEN_WIDTH * (P1 * 2), 0, SCREEN_WIDTH * P1, SCREEN_HEIGHT];
				// v = [0, 0, 0, 0];
				break;
			case 2:
				v = [P1 * SCREEN_WIDTH, 0, P1 * SCREEN_WIDTH, P2 * SCREEN_HEIGHT];
				if (panorama) v = [SCREEN_WIDTH * P1 * 3, 0, SCREEN_WIDTH * P1, SCREEN_HEIGHT];
				// v = [0, 0, 0, 0];
			...
			case 5:
				...
				if (panorama) v = [SCREEN_WIDTH * P1 * 1, 0, SCREEN_WIDTH * P1, SCREEN_HEIGHT];
				// v = [0, 0, 0, 0];
				break;
		}
